// _worker.js - For Cloudflare Pages Full-Stack Deployment (FINAL - SIMPLIFIED PROMPT)
  ...
  async fetch(request, env, context) {
    ...
    try {
      ...
      if (request.method === "POST" && url.pathname === "/") {
        ...
        // --- NEW, SIMPLER, AND MORE DIRECT PROMPT ---
        const translationPrompt = `Translate the following text to ${targetLang}. Important: Keep all proper nouns (like names of people, places, or companies) in their original English form. Text to translate: "${summaryText}"`;
