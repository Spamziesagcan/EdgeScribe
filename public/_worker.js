// _worker.js - For Cloudflare Pages Full-Stack Deployment (FINAL VERSION WITH NER SAFETY CHECK)
  ...
  async fetch(request, env, context) {
    ...
    try {
      ...
      if (request.method === "POST" && url.pathname === "/") {
        ...
        let namesToProtect = []; // Default to an empty array
        // SAFETY CHECK: Only process nerResponse if it's a valid array with items
        ...
        let translationPrompt = summaryText;
