// _worker.js - For Cloudflare Pages Full-Stack Deployment (DEFINITIVE - CURATED LIST + TAG METHOD)
  ...
  async fetch(request, env, context) {
    ...
    try {
      ...
      if (request.method === "POST" && url.pathname === "/") {
        ...
        // --- DEFINITIVE "TAG, INSTRUCT, AND CLEAN" LOGIC WITH A CURATED LIST ---

        // 1. TAG: Define the words to protect and wrap them in special tags.
        ...
        let taggedSummary = summaryText.replace(protectedWordsRegex, (match) => `<notranslate>${match}</notranslate>`);

        // 2. INSTRUCT: Create a very specific prompt for the AI.
        ...
        // 3. CLEAN: Remove our special tags from the final output.
